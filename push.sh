...
kubectl set image deployment/cla-assistant cla-assistant=gcr.io/cockroach-dev-inf/cockroachlabs/cla-assistant:$SHA

echo "Now monitoring pod status. ^C to quit"
kubectl get po --watch --selector 'app=cla-assistant'
